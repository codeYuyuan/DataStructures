    ...
    if (node == null){
      return null;
    	...
    	if(node.leftChild == null && node.rightChild == null){
          ...
          BinaryTreeNode nodeBigger = node.rightChild;
          while (nodeBigger.leftChild!=null){
            nodeBigger = nodeBigger.leftChild;
          }
          remove(nodeBigger.entry.key());
          size++;
          if(nodeBigger == node.rightChild){
        	  nodeBigger.parent = null;
        	  nodeBigger.leftChild = node.leftChild;
        	  root = nodeBigger;
      ...
      if(node.leftChild == null && node.rightChild == null){
        ...
        remove(nodeBigger.entry.key());
        size++;
        nodeBigger.parent= node.parent;
        if(node == node.parent.leftChild){
  		  node.parent.leftChild = nodeBigger;
  	  }else{
  		  node.parent.rightChild = nodeBigger;
  	  	}
        nodeBigger.leftChild = node.leftChild;
        nodeBigger.rightChild = node.rightChild;
      }
      size--;
      return node.entry;
    }
