  ...
  public void squish() {
    if (size != 0){
      ...
      while(currentNode.next!=null){
    	  while(currentNode.item.equals(currentNode.next.item)&&currentNode.next.next!=null){
    		  currentNode.next = currentNode.next.next;
    	  }
    	  if(currentNode.item.equals(currentNode.next.item)&&currentNode.next.next==null){
  ...
  public void twin() {
    if (size!=0) {
      ...
      while(currentNode !=null){
        SListNode addNode = new SListNode(currentNode.item,currentNode.next);
