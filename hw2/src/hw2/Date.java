...
class Date {
  ...
  public Date(String s) {
    ...
    String monthStr = s.substring(0,index1);
    String dayStr = s.substring(index1+1,index2);
    String yearStr = s.substring(index2+1);
  ...
  public static boolean isValidDate(int month, int day, int year) {
    if(year>=1 && 1<=month && 12>=month && 0 < day && day<= daysInMonth(month, year))
      return true;
    else 
      return false;                        // replace this line with your solution
  }
  ...
  public boolean isAfter(Date d) {
    if(d.month == this.month && d.day == this.day && d.year == this.year)
      return false;
    else if(isBefore(d))
      return false;
  ...
  public int difference(Date d) {
    ...
    if(d.year<this.year){
      ...
      sum += this.dayInYear()+ ((isLeapYear(d.year))? (366 - d.dayInYear()): (365 - d.dayInYear()));
      return sum;
    }
  ...
  public static void main(String[] argv){
    ...
    Date d6 = new Date(121312,123,123);
